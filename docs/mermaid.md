...
flowchart TD;
    ...
    id_reference(["<a href='../reference'>Reference</a>"]) --> id_quantity(["<a href='../quantity'>Quantity</a>"]);
    id_phenomenon(["<a href='../phenomenon'>Phenomenon</a>"]) --> id_entity(["<a href='../entity'>Entity</a>"]);
    ...
    id_phenomenon(["<a href='../phenomenon'>Phenomenon</a>"]) --> id_uncertainty(["<a href='../uncertainty'>Uncertainty</a>"]);
    ...
    id_observation(["<a href='../observation'>Observation</a>"]) --> id_sensor(["<a href='../sensor'>Sensor</a>"]);
    ...
    id_sample(["<a href='../sample'>Sample</a>"]) --> id_observation(["<a href='../observation'>Observation</a>"]);
    id_sample(["<a href='../sample'>Sample</a>"]) --> id_entity(["<a href='../entity'>Entity</a>"]);
    ...
    id_property(["<a href='../property'>Property</a>"]) --> id_remote_sensing(["<a href='../remote_sensing'>Remote Sensing</a>"]);
